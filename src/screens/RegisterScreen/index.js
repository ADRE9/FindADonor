...
import { StyleSheet, Text, View ,Image,Button, Pressable,Keyboard} from 'react-native'
    ...
    return (   
        <Screen>
            ...
            <TopView>
                           ...
                           touched,
                            ...
                            <>
                                <StyledInput
                                    ...
                                    autoCorrect={false}
                                    onBlur={handleBlur('name')} placeholder="Name"
                                />
                                ...
                                />
                                {values.phoneNumber.length !== 0 && errors.phoneNumber && touched.phoneNumber && (
                ...
                <SignupButton onPress={()=>navigation.navigate('Login')}><LoginText>BACK</LoginText></SignupButton>
            </BottomView>
            </Pressable>
        </Screen>
    )
