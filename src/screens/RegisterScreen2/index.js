...
import { StyleSheet, Text, View ,Image,Button, Pressable,Keyboard,ActivityIndicator} from 'react-native'
import { widthPercentageToDP as wp ,heightPercentageToDP as hp } from 'react-native-responsive-screen';
import { Screen } from '../../components/Screen';
import { SignupButton,LoginText,StyledInput,LoginButton } from '../LoginScreen/styledComponent';
...
const RegisterScreen2=({ navigation,route,registerUserAction,isLoading })=> {
    ...
    return (
        ...
        <Screen>
            ...
            <Image style={styles.img} source={require("../../assets/images/WaveMobile.png")} />
            <TopView>
                    ...
                    >
                        {({
                           ...
                           touched,
                            ...
                            />
                            {values.landmark.length !== 0 && errors.landmark && touched.landmark && (
                                <Errors texts={errors.landmark} />
                                )}
                            <StyledInput
                                placeholder="City"
                                value={values.city}
                            ...
                            />
                            {values.district.length !== 0 && errors.district && touched.district && (
                                <Errors texts={errors.district} />
                                )}
                            <StyledInput
                                placeholder="State"
                                value={values.state}
